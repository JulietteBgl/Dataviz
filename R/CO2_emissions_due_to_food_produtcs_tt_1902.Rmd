...
map <- ggplot(data = food_consumption_map) + 
  ...
  # annotate("text", x = 70, y = 150, family = "Gibson", size = 6, color = "gray90",
  #          label = "Poultry")
```
...
m <- plot_meat %>%
  ...
  annotate("text", x = "Beef", y = 62, size = 8, color = "#56B4E9",
           label = "Argentina") +
  annotate("text", x = "Poultry", y = 52, size = 8, color = "#56B4E9",
           label = "Australia") +
  annotate("text", x = "Poultry", y = 10, size = 8, color = "#56B4E9",
           label = "Albania") +
  annotate("text", x = "Beef", y = 18, size = 8, color = "#56B4E9",
           label = "New Zealand") +
  annotate("text", x = 	"Lamb & Goat", y = 30, size = 8, color = "#56B4E9",
           label = "Iceland")
```
...
```{r plot, fig.width = 25, fig.height = 30}
title /
  map / 
