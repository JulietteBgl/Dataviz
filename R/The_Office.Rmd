...
library("tidyr")
library("patchwork")
library("ggplotify") # set ggplot format to the radar chart
...
# 2e version avec suppression des commentaires

# supprimer les textes entre crochets []
# office2 <- office_filtered %>% 
...
# MFG logo
logo <- png::readPNG("../assets/MFG white logo.png")
...
comments <- ggdraw() +
  draw_label("Well rated seasons are the ones with\n both surprise and anticipation\n sentiments.\n\n On the other hand, seasons that bring fear\n and disgust have a lower rating.\n\n The first season stands out with its\n higher level of joy and trust.",
             ...
             size = 25,
             colour = "grey80") +
  #draw_image(logo#, x = 0, y = 0, scale = 1
             #) # doesn't work -- package magik ? to check
  draw_image("../assets/MFG white logo.png")
...
title /
  ...
  source + plot_layout(heights = c(0.3, 0.2, 0.2, 1, 0.2, 1, 0.2, 1, 0.1))
```
